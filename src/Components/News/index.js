            ...
            >
              ...
              <div className="newsblock__item">
                ...
                <div className="item__info">
                  ...
                  <p className="item__info--detail">
                    ...
                    Phòng Đẫm Máu” không phải là lựa chọn phù hợp đối với những
                    ai có tiền sử tim mạch hay huyết áp cao.
                  </p>
                </div>
              ...
              <div className="newsblock__item">
                ...
                <div className="item__info">
                  <h3 className="item__info--title">
                    <a href="#!">
                      Rờm - Phim thắng giải cao nhất tại LHP quốc tế Busan ấn
                      định ngày ra rạp tại Việt Nam
                    </a>
                  </h3>
                  <p className="item__info--detail">
                    Sau khi chính thức được cấp giấy phép phát hành, bộ phim Ròm
                    của đạo diễn Trần Thanh Huy thông báo ngày khởi chiếu tại
                    Việt Nam vào cuối tháng 7 tới đây.
                  </p>
                </div>
                <div className="item__interact">
                  <div className="item__interact--detail">
              ...
              <div className="newsblock__item">
                ...
                <div className="item__info">
                  ...
                  <p className="item__info--detail">
                    Phim chiếu rạp dịp Quốc tế Thiếu nhi của năm 2020 có phần
                    kém sôi động hơn những năm trước nhưng không vì vậy mà khán
                    giả nhỏ tuổi bị “ngó lơ”. Cùng điểm qua hai tựa phim hoạt
                    hình đầy màu sắc phiêu lưu, đáng yêu và cực kỳ ý nghĩa này
                    nghĩa của mùa Tết thiếu nhi trong cuối tuần này nào!.
                  </p>
                </div>
                <div className="item__interact">
                  <div className="item__interact--detail">
              ...
              <div className="newsblock__item">
                ...
                <div className="item__info">
                  ...
                  <p className="item__info--detail">
                    ...
                    Burns, cùng sự tham gia của dàn sao như Gwyneth Palt="tin
                    tuc"row, Matt Damon, Kate Winslet, Marion Cotillard,
                    Laurence Fishburne, Bryan Cranston và Jude Law.
                  </p>
                </div>
                <div className="item__interact">
                  <div className="item__interact--detail">
